...
public class StringArrayUtils {
    ...
    public static boolean isPalindromic(String[] array) {
        String[] arrBackwards = StringArrayUtils.reverse(array);
    ...
    public static String[] removeValue(String[] array, String valueToRemove) {
        ...
        String[] newArray = new String[listArr.size()];
    ...
    public static String[] removeConsecutiveDuplicates(String[] array) {
        ...
        for (int i = 1; i < array.length; i++){
            if (!array[i-1].equals(array[i]))
                listArr.add(array[i-1]);
        }

        if (!listArr.get(listArr.size()-1).equals(array[array.length-1]))
            listArr.add(array[array.length-1]);

        String[] newList = new String[listArr.size()];
        newList = listArr.toArray(newList);
        return newList;
    }
